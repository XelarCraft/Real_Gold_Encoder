...
public class Alice {
    ...
    /**
     * Derives an AES {@link SecretKeySpec} using a password and iteration count (if needed).
     *
     * @param password             the password
     * @param initializationVector used for PBKDF
     * @return an AES {@link SecretKeySpec}
     * @throws GeneralSecurityException if initialization, decryption, or the MAC comparison fails
     */
    ...
    /**
     * Generates an initialization vector using {@link SecureRandom} as the number generator
     *
     * @return a byte array
     */
